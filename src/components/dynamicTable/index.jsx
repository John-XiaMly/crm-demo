...
import { Mail, Phone, Calendar, ChartPie } from "lucide-react";
...
import ViewButton from "@/components/customButton/ViewButton.jsx";
import EditButton from "@/components/customButton/EditButton.jsx";
import DeleteButton from "@/components/customButton/DeleteButton.jsx";
        ...
        switch (val) {
            ...
            case "actions":
                ...
                >
                            ...
                            {onView && (
                                <ViewButton onView={onView} row={row} />
                            )}
                            {onEdit && (
                                <EditButton onEdit={onEdit} row={row} />
                            )}

                            {showDelete && confirmDelete && (
                                <DeleteButton onDelete={confirmDelete} row={row} />
                            )}
                        </Box>
                    </TableCell>
                );
